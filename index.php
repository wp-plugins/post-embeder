	...
	function display_embedarticles_widget() {
		...
		*/
		...
		if ($t == 'widget') {
			...
			if(is_single()) {
				$_data .= '<div style="display: block;">';
				$_data .= '<a id="embedarticles_button" href="http://www.isnare.com" data-url="'.get_permalink().'" data-key="'.get_option('embedarticles_pub_value').'" data-button-type="bb">Free Articles</a>';
