...
<div style="padding-bottom: 10px; margin-bottom: 10px; margin-right: 25px; border-bottom: 1px solid #555;">
	<div class="wrap">
		...
		<h2>Discover Embeddable Cards</span> <p><a href='https://pledgie.com/campaigns/26781'><img alt='Click here to lend your support to: EmbedArticles and make a donation at pledgie.com !' src='https://pledgie.com/campaigns/26781.png?skin_name=chrome' border='0' ></a></p></h2>
		
		<? if (!empty($pub_value) && isset($pub_value)) { ?>
		<div class="postbox" style="padding: 10px; margin: 0px;">
			<div id="archives">
				<ul>
					<li class="active"><a href="http://embedarticles.com/api/index.php?p=archives&k=<?=$pub_value?>&_a=list&q=<?=$_REQUEST['q']?>&_page=<?=$_REQUEST['_page']?>">Archives</a></li>
				</ul>
			</div>
		</div>
		<? } else { ?>
